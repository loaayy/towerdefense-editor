...
RangeEditorBehavior.SELECTED_COLOR          = {255, 255, 0, 255}
RangeEditorBehavior.SELECTED_LABEL_COLOR    = {0, 0, 0}
RangeEditorBehavior.UNSELECTED_COLOR        = {255, 255, 0, 255}
RangeEditorBehavior.UNSELECTED_LABEL_COLOR  = {0, 0, 0}
