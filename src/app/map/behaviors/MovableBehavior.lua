...
function MovableBehavior:setNextPosition(object)
    ...
    -- print(",",object.currentPointIndex_)
    -- print(object.nextPointIndex_)
...
function MovableBehavior:bind(object)
    ...
    local function tick(object, dt)
        ...
        --print(object.currentDist_,":",object.nextDist_)

        if currentDist >= object.nextDist_ then

            --print(currentDist,object.nextDist_)
    ...
    object:bindMethod(self, "getSpeed", getSpeed)

    local function getMoveTime(object,pos)

        if pos.x == object.x_ and pos.y == object.y_ then
            return
        end

       local currentDist  = math2d.dist(object.x_, object.y_,pos.x, pos.y)
       local time = currentDist / object.maxSpeed_ / 60
    ...
    object:bindMethod(self, "getMoveTime", getMoveTime)
...
function MovableBehavior:unbind(object)
    ...
    object:unbindMethod(self, "getSpeed")
    object:unbindMethod(self, "getMoveTime")
